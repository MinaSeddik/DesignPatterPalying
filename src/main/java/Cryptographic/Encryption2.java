...
public class Encryption2 {
    ...
    public static void main(String[] args) throws GeneralSecurityException, IOException {
        ...
        InputStream input = classLoader.getResourceAsStream("rootCA.crt");
        ...
        InputStream input2 = classLoader.getResourceAsStream("root_private_key.p12");  // contains private key + digital certificate
        keystore.load(input2, keystorePassword);
        PrivateKey privateKey = (PrivateKey) keystore.getKey("root_private", keyPassword);
